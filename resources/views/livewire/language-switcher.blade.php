<div x-data="{ open: false }" class="relative inline-block text-left">
    ...
    <button @click="open = !open"
            class="flex items-center gap-2  w-14 h-14 rounded-full px-3 py-2">

        @if($currentLocale === 'en')
            <img wire:click="switchLanguage('ar')" src="{{ asset('assets/images/img_36.png') }}" class="h-6 w-8" alt="Arabic Flag">
        @else
            <img wire:click="switchLanguage('en')" src="{{ asset('assets/images/img_37.png') }}" class="h-6 w-8" alt="English Flag">
        @endif
    </button>
